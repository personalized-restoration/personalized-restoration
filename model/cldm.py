...
from utils.common import frozen_module, frozen_module_ours
...
class ControlLDM(LatentDiffusion):
    ...
    def __init__(
        ...
        **kwargs
        ...
        frozen_module(self.model.diffusion_model.input_blocks)
        frozen_module(self.model.diffusion_model.middle_block)
    ...
    def apply_model(self, x_noisy, t, cond, *args, **kwargs):
        ...
        cond_txt_uncond = torch.load('emb_uncond.pt')
        ...
        if cond['c_latent'] is None:
            ...
            control = self.control_model(
                ...
                timesteps=t, context=cond_txt_uncond
            )
    ...
    def configure_optimizers(self):
        ...
        params = params[0:150] ## For relatively lower memory GPUs, this configuration will work
